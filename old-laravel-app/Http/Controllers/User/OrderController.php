...
class OrderController extends Controller
{
    ...
    {
        $pageTitle = 'My Orders';
        $pageDescription = 'Track and manage all your service orders with influencers';
        $pageIcon = 'bi bi-bag-check';
        $breadcrumbs = [
            ['title' => 'Services', 'url' => '#'],
            ['title' => 'Orders', 'url' => route('user.order.all')]
        ];
    ...
    public function detail($id)
    {
        ...
        $pageDescription = 'View details and manage your service order';
        $pageIcon = 'bi bi-file-earmark-text';
        $breadcrumbs = [
            ['title' => 'Services', 'url' => '#'],
            ['title' => 'Orders', 'url' => route('user.order.all')],
            ['title' => 'Order #' . $order->order_no, 'url' => route('user.order.detail', $id)]
        ];

        return view($this->activeTemplate . 'user.order.detail', compact(
            'pageTitle',
            'pageDescription',
            'pageIcon',
            'breadcrumbs',
