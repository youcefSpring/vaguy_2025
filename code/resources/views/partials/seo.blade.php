...
<meta name="title" Content="{{ $general->getPageTitle(__($pageTitle)) }}">
...
@if($seoContents)
    ...
    <meta name="apple-mobile-web-app-title" content="{{ $general->getPageTitle($pageTitle) }}">
    {{--<!-- Google / Search Engine Tags -->--}}
    <meta itemprop="name" content="{{ $general->getPageTitle($pageTitle) }}">
