...
<div class="space-y-6">
    <div class="flex justify-between items-center">
        <h2 class="text-2xl font-bold text-gray-900">@lang('تقييم الخدمة')</h2>
    ...
    <div class="bg-white shadow rounded-lg p-6">
        <div class="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
            <h3 class="text-lg font-medium text-blue-900 mb-2">
                @lang('العنوان'): {{ __(@$order->service->title) }}
            </h3>
        </div>

        <form action="{{ localized_route('user.review.service.add', @$order->id) }}" method="POST" class="space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <div class="relative">
                        <input type="text"
                               ...
                               value="{{ __(@$order->influencer->fullname) }}"
                               readonly>
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="text"
                               class="input w-full bg-gray-50"
                               value="{{ __(@$order->influencer->email) }}"
                               readonly>
            ...
            <div>
                ...
                <div class="relative">
                    <textarea name="review"
                              ...
                              required>@if(@$order->review){{ @$order->review->review }}@else{{ old('review') }}@endif</textarea>
