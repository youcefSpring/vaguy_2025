    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div class="lg:col-span-4">
            <div class="lg:sticky lg:top-6">
                <!-- Header -->
                <div class="mb-6">
                    <h2 class="text-2xl lg:text-3xl font-bold text-gray-900 dark:text-white">@lang('Identity Verification')</h2>
                    <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">@lang('Complete verification to unlock all features')</p>
                </div>
                ...
                <div class="mb-6 flex items-start gap-3 p-4 rounded-xl bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 border border-blue-200 dark:border-blue-800/30">
                    ...
                    <p class="text-xs leading-relaxed text-blue-800 dark:text-blue-300">{{ __($kycContent->data_values->verification_content ?? 'Complete verification to access all features') }}</p>
                </div>
                @endif

                <!-- Security Note -->
                <div class="p-4 rounded-xl bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800/30">
                    <div class="flex items-start gap-3">
                        <svg class="w-5 h-5 text-green-600 dark:text-green-400 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clip-rule="evenodd"/>
                        </svg>
                        <div>
                            <h3 class="text-sm font-semibold text-green-900 dark:text-green-300">@lang('Secure & Private')</h3>
                            <p class="mt-1 text-xs text-green-700 dark:text-green-400">@lang('Your data is encrypted and secure')</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="lg:col-span-8">
            <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-lg">
                <form action="{{ localized_route('user.kyc.submit') }}" method="post" enctype="multipart/form-data" class="p-6 lg:p-8">
                    @csrf
...
<style>
    ...
    .viser-form-group textarea {
        @apply w-full px-3 py-2.5 text-sm border border-gray-300 dark:border-gray-600 rounded-lg
    ...
    .viser-form-group input[type="file"] {
        @apply w-full text-sm border border-gray-300 dark:border-gray-600 rounded-lg
               bg-white dark:bg-gray-700/50 text-gray-700 dark:text-gray-300
               file:mr-3 file:py-2 file:px-4 file:rounded-md file:border-0
               file:text-xs file:font-medium file:bg-gradient-to-r file:from-purple-600 file:to-indigo-600 file:text-white
    ...
    .viser-form-group textarea {
        @apply min-h-[100px] resize-y leading-relaxed;
    }
