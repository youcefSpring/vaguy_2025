...
<div class="d-flex justify-content-between align-items-center position-relative mb-4 flex-wrap gap-4">
    ...
    <div class="d-flex justify-content-between flex-wrap gap-3">
        ...
        <div class="d-flex align-items-start flex-wrap gap-2">
            <a class="btn btn--outline-custom {{ menuActive('influencer.hiring.index') }}" aria-current="page" href="{{ localized_route('influencer.hiring.index') }}">@lang('الكل')</a>
            <a class="btn btn--outline-custom {{ menuActive('influencer.hiring.pending') }}" href="{{ localized_route('influencer.hiring.pending') }}">@lang('قيد الانتظار') ({{ $pendingHiring??0 }})</a>
            <a class="btn btn--outline-custom {{ menuActive('influencer.hiring.inprogress') }}" href="{{ localized_route('influencer.hiring.inprogress') }}">@lang('الجاري')</a>
            <a class="btn btn--outline-custom {{ menuActive('influencer.hiring.jobDone') }}" href="{{ localized_route('influencer.hiring.jobDone') }}">@lang('عمل منجز')</a>
            <a class="btn btn--outline-custom {{ menuActive('influencer.hiring.completed') }}" href="{{ localized_route('influencer.hiring.completed') }}">@lang('مكتمل')</a>
            <a class="btn btn--outline-custom {{ menuActive('influencer.hiring.reported') }}" href="{{ localized_route('influencer.hiring.reported') }}">@lang('مؤجل')</a>
            <a class="btn btn--outline-custom {{ menuActive('influencer.hiring.cancelled') }}" href="{{ localized_route('influencer.hiring.cancelled') }}">@lang('ملغى')</a>
        </div>
...
<div class="row mt-2">
    <div class="col-lg-12">
        <table class="table--responsive--lg table">
            <thead>
                <tr>
                    <th>@lang('عدد الوظائف')</th>
                    <th>@lang('اسم المستخدم')</th>
                    <th class="text-center">@lang('القمة | التوصيل')</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td data-label="@lang('القمة | التوصيل')" class="text-center">
                        <div>
