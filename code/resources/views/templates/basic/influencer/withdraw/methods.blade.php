...
<div class="row justify-content-center">
    <div class="col-lg-12">
        <div class="card custom--card">
            <div class="card-body">
                <form action="{{ localized_route('influencer.withdraw.money') }}" method="post" class="from row gy-2">
                    @csrf
                    <div class="form-group">
                        <label class="form-label">@lang('طريقة الدفع')</label>
                        <select class="form-control form--control form-select" name="method_code" required>
                            <option value="">@lang('حدد الطريقة')</option>
                    ...
                    <div class="form-group">
                        <label class="form-label">@lang('المبلغ')</label>
                    ...
                    <div class="preview-details d-none my-3">
                        <ul class="list-group-flush text-center">
                            ...
                            <li class="list-group-item d-flex justify-content-between">
                                <span>@lang('المستحق')</span> <span><span class="receivable fw-bold"> 0</span>
                            ...
                            <li class="list-group-item d-none justify-content-between in-site-cur">
                                <span>@lang('في') <span class="base-currency"></span></span>
