                        ...
                        <div class="account-content">
                            ...
                            <div class="d-flex justify-content-between flex-wrap gap-3 pb-5">
                                ...
                                <div class="account-content-right">
                                    <button type="button" class="btn btn--md btn--outline-base actionBtn active" data-type="client">@lang('عميل')</button>
                                    <button type="button" class="btn btn--md btn--outline-base actionBtn" data-type="influencer">@lang('مؤثر')</button>
                                </div>
                            </div>

                            <form method="POST" action="{{ localized_route('user.login') }}" class="account-form verify-gcaptcha">
                                @csrf
                                <div class="form-group">
                                    <label class="form-label">@lang('اسم المستخدم أو البريد الالكتروني') </label>
                                    <input type="text" name="username" value="{{ old('username') }}" class="form-control form--control" required>
                                </div>
                                <div class="form-group">
                                    <label for="password" class="form-label">@lang('كلمة المرور') </label>
                                ...
                                <div class="d-flex justify-content-between flex-wrap">
                                    ...
                                    <a class="text--base forgot-url" href="{{ localized_route('user.password.request') }}">@lang('هل نسيت كلمة السر؟')</a>
                                </div>
                                <button type="submit" id="recaptcha" class="btn btn--base w-100">@lang('حفظ')</button>
                            </form>
                            <div class="text-center">
                                <p class="mt-4">@lang('ليس لديك حساب ؟')
                                    <a href="{{ localized_route('user.register') }}" class="text--base register-url">@lang('انشاء حساب')</a>
                                </p>
                            </div>
                        </div>
                    </div>
