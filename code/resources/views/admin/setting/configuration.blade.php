                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <p class="mb-0">
                                    <small>@lang('If you enable this module, that means a user must have to agree with your system\'s') <a href="{{ localized_route('admin.frontend.sections','policy_pages') }}">@lang('policies')</a> @lang('during registration.')</small>
                                </p>
                            </div>
                            <div class="form-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            <div>
                                <p class="fw-bold mb-0">@lang('Client KYC Verification')</p>
                                <p class="mb-0">
                                    <small>@lang('If you enable') <span class="fw-bold">@lang('KYC (Know Your Client)')</span> @lang('module, clients must have to submit') <a href="{{ localized_route('admin.kyc.setting') }}">@lang('the required data')</a>. @lang('Otherwise, client can\'t hire influencers')</small>
                                </p>
                            </div>
                            <div class="form-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            <div>
                                <p class="fw-bold mb-0">@lang('Influencer KYC Verification')</p>
                                <p class="mb-0">
                                    <small>@lang('If you enable') <span class="fw-bold">@lang('KYC (Know Your Client)')</span> @lang('module, influencers must have to submit') <a href="{{ localized_route('admin.influencer.kyc.setting') }}">@lang('the required data')</a>. @lang('Otherwise, influencers can\'t access on main functionalities of this system like crating services, taking jobs or orders, and communicating with clients.')</small>
                                </p>
                            </div>
                            <div class="form-group">
                                <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" name="influencer_kv" @if ($general->influencer_kv) checked @endif>
                            </div>
                        </li>
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            <div>
                                <p class="fw-bold mb-0">@lang('Service Approval')</p>
                                <p class="mb-0">
                                    <small>@lang('If you enable this module, the system will automatic approve service') <code>@lang('So be sure before disabling this module that, the system doesn\'t need to send any SMS.')</code></small>
                                </p>
                            </div>
                            <div class="form-group">
                                <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" name="service_approve" @if ($general->service_approve) checked @endif>
                            </div>
                        </li>
