...
@section('panel')
    <div class="row">
        ...
        <div class="col-xl-12">
            <div class="card">
                <form action="{{ localized_route('admin.subscriber.send.email') }}" method="POST">
                    @csrf
                    <div class="card-body">
                        <div class="row">
...
@push('breadcrumb-plugins')
    <a href="{{ localized_route('admin.subscriber.index') }}" class="btn btn-sm btn-outline--primary"><i class="las la-undo"></i> @lang('Back')</a>
@endpush
