                                ...
                                <tr>
                                    ...
                                    <td data-label="@lang('Action')">
                                        <button href="javascript:void(0)"
                                           ...
                                           data-action="{{ localized_route('admin.subscriber.remove',$subscriber->id) }}"
                                        >
...
@push('breadcrumb-plugins')
    <a href="{{ localized_route('admin.subscriber.send.email') }}" class="btn btn-sm btn-outline--primary" ><i class="las la-paper-plane"></i>@lang('Send Email')</a>
@endpush
