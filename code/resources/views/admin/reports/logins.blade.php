                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-label="@lang('User')">
                                    ...
                                    <br>
                                    <span class="small"> <a href="{{ localized_route('admin.users.detail', $log->user_id) }}"><span>@</span>{{ @$log->user->username }}</a> </span>
                                </td>
                                ...
                                <td data-label="@lang('IP')">
                                    <span class="fw-bold">
                                        <a href="{{localized_route('admin.report.login.ipHistory',[$log->user_ip])}}">{{ $log->user_ip }}</a>
                                    </span>
                                </td>
