...
@section('panel')
    ...
    <form action="{{ localized_route('admin.setting.notification.template.update',$template->id) }}" method="post">
        @csrf
        <div class="row">
            <div class="col-md-6">
                <div class="card mt-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="checkbox" data-height="45px" data-width="100%" data-onstyle="-success"
...
@push('breadcrumb-plugins')
    <a href="{{ localized_route('admin.setting.notification.templates') }}" class="btn btn-sm btn-outline--primary"><i class="las la-undo"></i> @lang('Back') </a>
@endpush
