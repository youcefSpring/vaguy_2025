...
<div class="row">
            ...
            <div class="card-body p-0">
                <div class="table-responsive table-responsive--sm">
                    <table class=" table align-items-center table--light">
                        ...
                        <tbody class="list">
                        <tr>
                            <td data-label="@lang('Short Code')"><span class="short-codes">@{{fullname}}</span></td>
                            <td data-label="@lang('Description')">@lang('Full Name of User')</td>
                        </tr>
                        <tr>
                            <td data-label="@lang('Short Code')"><span class="short-codes">@{{username}}</span></td>
                            <td data-label="@lang('Description')">@lang('Username of User')</td>
                        </tr>
                        <tr>
                            <td data-label="@lang('Short Code')"><span class="short-codes">@{{message}}</span></td>
    ...
    <div class="col-md-12">
        <div class="card mt-5">
            <div class="card-body">
                <form action="{{ localized_route('admin.setting.notification.global.update') }}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-md-12">
