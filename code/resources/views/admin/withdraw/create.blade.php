...
@section('panel')
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <form action="{{ localized_route('admin.withdraw.method.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
...
@push('breadcrumb-plugins')
    <a href="{{ localized_route('admin.withdraw.method.index') }}" class="btn btn-sm btn-outline--primary">
