                                ...
                                @forelse($reviews as $review)
                                    <tr>
                                        <td data-label="@lang('Hiring Number')">
                                            <span class="fw-bold">
                                                <a href="{{ localized_route('admin.hiring.detail', $review->hiring_id) }}">{{ @$review->hiring->hiring_no }}</a>
                                            </span>
                                        </td>
                                        ...
                                        <td data-label="@lang('Action')">
                                            ...
                                            <a href="#" class="btn btn-sm btn-outline--danger confirmationBtn" data-action="{{ localized_route('admin.reviews.influencer.delete',$review->id) }}" data-question="@lang('Are you sure remove this review?')" data-btn_class="btn btn--primary">
