        ...
        <div class="col-lg-9 col-md-9 mb-30">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ localized_route('admin.password.update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
...
@push('breadcrumb-plugins')
    <a href="{{localized_route('admin.profile')}}" class="btn btn-sm btn-outline--primary" ><i class="las la-user"></i>@lang('Profile Setting')</a>
@endpush
