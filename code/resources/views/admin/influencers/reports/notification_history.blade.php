                                    ...
                                    <tr>
                                        <td data-label="@lang('User')">
                                            ...
                                            <span class="fw-bold">{{ $log->influencer->fullname }}</span>
                                                <br>
                                            <span class="small">
                                                <a href="{{ localized_route('admin.influencers.detail', $log->influencer_id) }}"><span>@</span>{{ $log->influencer->username }}</a>
                                            </span>
                                            @else
...
@push('breadcrumb-plugins')
    @if(@$influencer)
        <a href="{{ localized_route('admin.influencers.notification.single',$influencer->id) }}" class="btn btn-outline--primary btn-sm"><i class="las la-paper-plane"></i> @lang('Send Notification')</a>
    @else
