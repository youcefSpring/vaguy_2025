                        ...
                        <table class="table table--light style--two">
                            ...
                            @forelse($loginLogs as $log)
                                ...
                                <td data-label="@lang('User')">
                                        ...
                                        <br>
                                        <span class="small"> <a href="{{ localized_route('admin.influencers.detail', $log->influencer_id) }}"><span>@</span>{{ @$log->influencer->username }}</a> </span>
                                    ...
                                    <td data-label="@lang('IP')">
                                        <span class="fw-bold">
                                        <a href="{{localized_route('admin.influencer.report.login.ipHistory',[$log->user_ip])}}">{{ $log->user_ip }}</a>
                                        </span>
                                    </td>
...
@push('breadcrumb-plugins')
    ...
    <form action="{{ localized_route('admin.report.login.history') }}" method="GET" class="form-inline float-sm-end">
