...
@section('panel')
    <div class="row">
        <div class="col-lg-12">
            <div class="card mb-4">
                <form action="{{ localized_route('admin.gateway.manual.update', $method->code) }}" method="POST"
...
@push('breadcrumb-plugins')
    <a href="{{ localized_route('admin.gateway.manual.index') }}" class="btn btn-sm btn-outline--primary"><i class="la la-undo"></i> @lang('Back') </a>
@endpush
