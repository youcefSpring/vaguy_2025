...
@section('panel')
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <form action="{{ localized_route('admin.gateway.automatic.update', $gateway->code) }}" method="POST"
                                        ...
                                        @foreach($gateway->extra as $key => $param)
                                            <div class="form-group col-lg-6">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control" value="{{ localized_route($param->value) }}" readonly/>
                                        ...
                                        <div class="content w-100 ps-0">
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <div class="remove-btn">
                                                    <button type="button" class="btn btn--danger confirmationBtn" data-question="@lang('Are you sure to delete this gateway currency?')" data-action="{{ localized_route('admin.gateway.automatic.remove',$gatewayCurrency->id) }}">
...
@push('breadcrumb-plugins')
    <a href="{{ localized_route('admin.gateway.automatic.index') }}" class="btn btn-sm btn-outline--primary"><i class="la la-undo"></i>@lang('Back')</a>
@endpush
