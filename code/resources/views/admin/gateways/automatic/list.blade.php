                                ...
                                <tr>
                                    ...
                                    <td data-label="@lang('Action')">
                                        <div class="button--group">
                                            <a href="{{ localized_route('admin.gateway.automatic.edit', $gateway->alias) }}" class="btn btn-sm btn-outline--primary editGatewayBtn">
                                                <i class="la la-pencil"></i> @lang('Edit')
                                            </a>


                                            @if($gateway->status == 0)
                                                <button class="btn btn-sm btn-outline--success ms-1 confirmationBtn" data-question="@lang('Are you sure to enable this gateway?')" data-action="{{ localized_route('admin.gateway.automatic.activate',$gateway->code) }}">
                                                    <i class="la la-eye"></i> @lang('Enable')
                                                </button>
                                            @else
                                                <button class="btn btn-sm btn-outline--danger ms-1 confirmationBtn" data-question="@lang('Are you sure to disable this gateway?')" data-action="{{ localized_route('admin.gateway.automatic.deactivate',$gateway->code) }}">
