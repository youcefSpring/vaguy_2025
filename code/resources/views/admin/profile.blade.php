        ...
        <div class="col-xl-9 col-lg-8 mb-30">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ localized_route('admin.profile.update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
...
@push('breadcrumb-plugins')
    <a href="{{localized_route('admin.password')}}" class="btn btn-sm btn-outline--primary"><i class="las la-key"></i>@lang('Password Setting')</a>
@endpush
