                                    ...
                                    <td data-label="@lang('Action')">
                                        <div class="button--group">
                                            <button type="button" class="btn btn-sm btn-outline--primary ms-1 mb-2 editBtn"
                                                    ...
                                                    data-action="{{ localized_route('admin.extensions.update', $extension->id) }}">
                                            ...
                                            @if($extension->status == 0)
                                                <button type="button"
                                                        ...
                                                        data-action="{{ localized_route('admin.extensions.status', $extension->id) }}"
                                                        data-question="@lang('Are you sure to enable this extension?')" data-btn_class="btn btn--primary btn--md">
                                                    <i class="la la-eye"></i> @lang('Enable')
                                                </button>
                                            @else
                                                <button type="button" class="btn btn-sm btn-outline--danger mb-2 confirmationBtn"
                                                data-action="{{ localized_route('admin.extensions.status', $extension->id) }}"
                                                data-question="@lang('Are you sure to disable this extension?')" data-btn_class="btn btn--primary btn--md">
