                        ...
                        <table class="table table--light style--two">
                            ...
                            <tr>
                                <td data-label="@lang('User')">
                                    ...
                                    <br>
                                    <span class="small">
                                    <a href="{{ localized_route('admin.users.detail', $user->id) }}"><span>@</span>{{ $user->username }}</a>
                                    </span>
                                </td>
                                ...
                                <td data-label="@lang('Action')">
                                    <a href="{{ localized_route('admin.users.detail', $user->id) }}" class="btn btn-sm btn-outline--primary">
