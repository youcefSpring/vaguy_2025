...
<div class="row">
    <div class="col-12">
        <div class="row gy-4">
            ...
            <div class="col-xxl-3 col-sm-6">
                <div class="widget-two style--two box--shadow2 b-radius--5 bg--primary">
                    ...
                    <a href="{{ localized_route('admin.deposit.list') }}?search={{ $user->username }}" class="widget-two__btn">@lang('View All')</a>
                </div>
            </div>
            <!-- dashboard-w1 end -->
            <!-- dashboard-w1 end -->
            ...
            <div class="col-xxl-3 col-sm-6">
                <div class="widget-two style--two box--shadow2 b-radius--5 bg--17">
                    ...
                    <a href="{{ localized_route('admin.report.transaction') }}?search={{ $user->username }}" class="widget-two__btn">@lang('View All')</a>
                </div>
            </div>
            <!-- dashboard-w1 end -->
            ...
            <div class="col-xxl-3 col-sm-6">
                <div class="widget-two style--two box--shadow2 b-radius--5 bg--blue">
                    ...
                    <a href="{{ localized_route('admin.order.index') }}?search={{ $user->username }}" class="widget-two__btn">@lang('View All')</a>
                </div>
            </div>
            ...
            <div class="col-xxl-3 col-sm-6">
                <div class="widget-two style--two box--shadow2 b-radius--5 bg--success">
                    ...
                    <div class="widget-two__content">
                        <h3 class="text-white">{{ $totalHired }}</h3>
                        <p class="text-white">@lang('Total Hired')</p>
                    </div>
                    <a href="{{ localized_route('admin.hiring.index') }}?search={{ $user->username }}" class="widget-two__btn">@lang('View All')</a>
                </div>
            </div>
        ...
        <div class="d-flex flex-wrap gap-3 mt-4">
            ...
            <div class="flex-fill">
                <a href="{{localized_route('admin.report.login.history')}}?search={{ $user->username }}" class="btn btn--primary btn--shadow w-100 btn-lg">
                    <i class="las la-list-alt"></i>@lang('Logins')
                </a>
            </div>

            <div class="flex-fill">
                <a href="{{ localized_route('admin.users.notification.log',$user->id) }}" class="btn btn--secondary btn--shadow w-100 btn-lg">
                    <i class="las la-bell"></i>@lang('Notifications')
                </a>
            </div>

            <div class="flex-fill">
                <a href="{{route('admin.users.user.login', ['locale' => app()->getLocale(), 'id' => $user->id])}}" target="_blank" class="btn btn--primary btn--gradi btn--shadow w-100 btn-lg">
            ...
            @if($user->kyc_data)
            <div class="flex-fill">
                <a href="{{ localized_route('admin.users.kyc.details', $user->id) }}" target="_blank" class="btn btn--dark btn--shadow w-100 btn-lg">
        ...
        <div class="card mt-30">
            ...
            <div class="card-body">
                <form action="{{localized_route('admin.users.update',[$user->id])}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        <div class="form-group  col-xl-3 col-md-6 col-12">
                            ...
                            <input type="checkbox" data-width="100%" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle"
                                data-on="@lang('Verified')" data-off="@lang('Unverified')" name="ev" @if($user->ev) checked @endif>
                        ...
                        <div class="form-group  col-xl-3 col-md-6 col-12">
                            ...
                            <input type="checkbox" data-width="100%" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle"
                                data-on="@lang('Verified')" data-off="@lang('Unverified')" name="sv" @if($user->sv) checked @endif>
                        ...
                        <div class="form-group col-xl-3 col-md- col-12">
                            ...
                            <input type="checkbox" data-width="100%" data-height="50" data-onstyle="-success" data-offstyle="-danger"
                                data-bs-toggle="toggle" data-on="@lang('Enable')" data-off="@lang('Disable')" name="ts" @if($user->ts) checked @endif>
                        </div>
                        <div class="form-group col-xl-3 col-md- col-12">
                            <label>@lang('KYC') </label>
                            <input type="checkbox" data-width="100%" data-height="50" data-onstyle="-success" data-offstyle="-danger"
                                data-bs-toggle="toggle" data-on="@lang('Verified')" data-off="@lang('Unverified')" name="kv" @if($user->kv == 1)
                            checked @endif>
                        </div>
                    </div>
...
<div id="addSubModal" class="modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{localized_route('admin.users.add.sub.balance',$user->id)}}" method="POST">
                @csrf
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="number" step="any" name="amount" class="form-control" placeholder="@lang('Please provide positive amount')"
                                required>
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">
                    @if($user->status == 1)
                    <span>@lang('Ban Client')</span>
                    @else
                    <span>@lang('Unban Client')</span>
                    @endif
                </h5>
                <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                    <i class="las la-times"></i>
            ...
            <form action="{{localized_route('admin.users.status',$user->id)}}" method="POST">
                @csrf
                <div class="modal-body">
                    @if($user->status == 1)
                    <h6 class="mb-2">@lang('If you ban this client he/she won\'t able to access his/her dashboard.')</h6>
                    <div class="form-group">
                    ...
                    <p>{{ $user->ban_reason }}</p>
                    <h4 class="text-center mt-3">@lang('Are you sure to unban this client?')</h4>
                    @endif
                </div>
                <div class="modal-footer">
                    @if($user->status == 1)
