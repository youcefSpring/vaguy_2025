...
<div class="row mb-4">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <form action="{{ localized_route('admin.frontend.manage.pages.update')}}" method="POST">
                    @csrf
...
<div class="row">
    <div class="col-md-7">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{localized_route('admin.frontend.manage.section.update',$pdata->id)}}" method="post">
                    @csrf
                    <ol class="simple_with_drop vertical sec-item">
                        ...
                        <li class="highlight icon-move item">
                            ...
                            <span class="d-inline-block text-white me-auto ml-2"> {{ __(@$sections[$sec]['name']) }}</span>
                    ...
                    <li class="highlight icon-move clearfix">
                            ...
                            @if($secs['builder'])
                                <div class="float-end d-inline-block manage-content">
                                    <a href="{{ localized_route('admin.frontend.sections',$k) }}" target="_blank" class="btn btn-outline-light text-center text-white cog-btn" title="@lang('Manage Content')">
...
<a href="{{localized_route('admin.frontend.manage.pages')}}"  class="btn btn-sm btn-outline--primary"><i class="la la-undo"></i> @lang('Back') </a>
@endpush
