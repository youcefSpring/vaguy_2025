...
@section('panel')
    <div class="notify__area">
        ...
        <a class="notify__item @if($notification->read_status == 0) unread--notification @endif" href="{{ localized_route('admin.notification.read',$notification->id) }}">
...
<a href="{{ localized_route('admin.notifications.readAll') }}" class="btn btn-outline--primary">@lang('Mark All as Read')</a>
@endpush
