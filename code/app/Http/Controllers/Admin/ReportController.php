...
class ReportController extends Controller
{
    public function transaction(Request $request)
    {
        ...
        $transactions = Transaction::where('user_id','!=',0)->with('user','influencer')->orderBy('id','desc');
    ...
    {
        $loginLogs = UserLogin::where('user_id','!=',0)->orderBy('id','desc')->with('user','influencer');
    ...
    public function loginIpHistory($ip)
    {
        ...
        $loginLogs = UserLogin::where('user_id','!=',0)->where('user_ip',$ip)->orderBy('id','desc')->with('user')->paginate(getPaginate());
    ...
    public function notificationHistory(Request $request){
        ...
        $logs = NotificationLog::where('user_id','!=',0)->orderBy('id','desc');
        $search = $request->search;
        if ($search) {
    ...
    public function emailDetails($locale, $id){
