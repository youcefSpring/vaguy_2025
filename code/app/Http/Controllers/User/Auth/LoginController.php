...
class LoginController extends Controller
{
    ...
    */
    ...
    {
        return localized_route('user.home', [], false);
    }
    ...
    public function findUsername()
    {
        ...
        // dd($fieldType);
        // $fieldType = $this->isEmail($login) ? 'email' : 'username';
    ...
    public function isEmail($login) {
        ...
        return (bool) preg_match($emailPattern, $login);
    } 
    ...
    public function logout()
    {
        ...
        return to_localized_route('user.login')->withNotify($notify);
    }
