...
class ConversationController extends Controller {
    ...
    public function view(Request $request, $locale, $id) {
        ...
        return view($this->activeTemplate . 'user.conversation.view', compact('pageTitle', 'conversation', 'conversationMessage', 'influencer', 'conversations'));
