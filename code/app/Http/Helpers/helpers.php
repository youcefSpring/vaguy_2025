 ...
 * Automatically includes the current locale parameter.
 *
...
/**
 * Redirect to a localized named route.
 * Automatically includes the current locale parameter.
 ...
 */
if (!function_exists('redirect_localized')) {
    function redirect_localized($name, $parameters = [], $status = 302, $headers = [])
    {
        // Ensure parameters is an array
        if (!is_array($parameters)) {
            $parameters = [$parameters];
...
/**
 * Create a redirect response to a named route using to_route() style.
 * Automatically includes the current locale parameter.
 * For use in controllers and middleware.
 *
 * @param string $name Route name
 ...
 * @return \Illuminate\Http\RedirectResponse
 */
if (!function_exists('to_localized_route')) {
    function to_localized_route($name, $parameters = [], $status = 302, $headers = [])
    {
        // Ensure parameters is an array
        if (!is_array($parameters)) {
            $parameters = [$parameters];
